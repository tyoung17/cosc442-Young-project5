...
public class WMethod{
   ...
   */
   public static void main(String [] args){
     ...
     String testableTestCase = "";
     String[] testCases = tests.toArray(new String[tests.size()]);
     for (int i = 0; i < testCases.length; i++) {
         testableTestCase = testableTestCase + (testCases[i]);
         if (i != (testCases.length - 1)) {
             testableTestCase = testableTestCase + " ";
         }
     } 
    
     char[] testCases1 = testableTestCase.toCharArray();
     String str = "";
